...
import { Bell, MailCheck } from '@vatic/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <VaticIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <VaticScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <VaticButton size="sm" @click="handleViewAll">
